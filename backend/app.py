...
# --- AUTO-RUN GDrive Parallel ETL v5.0 BACKGROUND TASK ---
def run_gdrive_ingestion_loop():
    """Background loop using the new High-Performance Incremental Engine v5.0."""
    try:
        from model.robust_gdrive_etl_v2 import GDriveHighSpeedIngestor
        ingestor = GDriveHighSpeedIngestor()
        # The version message is now handled inside robust_gdrive_etl_v2.py
        while True:
            try:
...
# Background task will be started in the main block
