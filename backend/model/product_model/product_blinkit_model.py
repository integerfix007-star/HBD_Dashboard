...
class BlinkitProduct(db.Model):
    __tablename__ = 'blinkit_products'
    ...
    Dark_Store_ID = db.Column(db.String(100))
    Delivery_Partner_ID = db.Column(db.String(100))
    Estimated_Time_Min = db.Column(db.Integer)
    Pick_Status = db.Column(db.String(100))
    Surge_Charge_Multiplier = db.Column(db.String(50))
