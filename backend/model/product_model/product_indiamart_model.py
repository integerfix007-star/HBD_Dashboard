...
class IndiaMartProduct(db.Model):
    __tablename__ = 'india_mart_products'
    ...
    RFQ_ID = db.Column(db.String(100))
    Buyer_Lead_Nature = db.Column(db.String(100))
    Min_Order_Value = db.Column(db.String(100))
    Supplier_Verif_Level = db.Column(db.String(50))
    Bulk_Discount_Tiers = db.Column(db.Text)
    ...
    def to_dict(self):
        ...
        return {
            ...
            "rfq_id": self.RFQ_ID,
            "buyer_lead_nature": self.Buyer_Lead_Nature,
            "min_order_value": self.Min_Order_Value,
            "supplier_verif_level": self.Supplier_Verif_Level,
            "bulk_discount_tiers": self.Bulk_Discount_Tiers,
