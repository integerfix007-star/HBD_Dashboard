...
class ZomatoProduct(db.Model):
    __tablename__ = 'zomato_products'
    ...
    Menu_Item_Category = db.Column(db.String(255))
    Add_On_Group_ID = db.Column(db.String(100))
    Hygiene_Rating = db.Column(db.String(50))
    Delivery_ETA_Factor = db.Column(db.String(100))
    ...
    def to_dict(self):
        ...
        return {
            ...
            "menu_item_category": self.Menu_Item_Category,
            "add_on_group_id": self.Add_On_Group_ID,
            "hygiene_rating": self.Hygiene_Rating,
            "delivery_eta_factor": self.Delivery_ETA_Factor,
