...
const BigBasketUploader = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await api.post(
        "/bigbasket/upload/bigbasket-data",
        formData,
        {
          headers: {
  ...
  return (
    <div className="p-6 max-w-xlg bg-white rounded-lg shadow mt-6">
      <h2 className="text-xl font-bold mb-4">Upload BigBasket CSV Files</h2>
...
export default BigBasketUploader;
